...
export interface UseMotionProps {
     ...
     */
    elementRef?: React.RefObject<HTMLElement | undefined> | HTMLElement | undefined;
    /**
    ...
    /**
     * The hide strategy of the motion.
     * - `'display'` - hides with `display: none`
     * - `'visibility'` - hides with `visibility: hidden`
     * - `'none'` - no hiding, CSS handles it (e.g. height-based)
     */
    hideStrategy?: 'display' | 'visibility' | 'none' | undefined;
    /**
...
export interface UseMotionExposes {
    ...
    /**
     * Pre-built props for the root element with hidden style when not visible.
     */
    rootProps: {

...
export type Types = 'headless' | 'primitive' | 'ui';
...
export type BaseInstance<IProps = Record<PropertyKey, unknown>, Ref = unknown, ERef = HTMLElement> = {
     ...
     */
    elementRef: React.RefObject<ERef | undefined>;
    /**
     * The component id.
     */
    id?: string | undefined;
 ...
 */
export type Instance<Props = Record<PropertyKey, unknown>, IProps = Record<PropertyKey, unknown>, State = Record<PropertyKey, unknown>, Exposes = Record<PropertyKey, unknown>, Ref = unknown, ERef = HTMLElement> = CommonInstance<Props, IProps, Ref, ERef> & {
    /**
     * The component state.
     */
    state: State;

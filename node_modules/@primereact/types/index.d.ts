 ...
 */
export declare type BaseComponentProps<I extends ComponentInstance = ComponentInstance, H = unknown, P = unknown, T extends React.ElementType = React.ElementType, O extends string[] = []> = CommonComponentProps<I, H, P, T> & Omit<ExtractProps<T>, keyof CommonComponentProps<I, H, P, T> | O[number]>;

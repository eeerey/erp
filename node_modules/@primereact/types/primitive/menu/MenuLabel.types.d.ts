...
import type { MenuGroupContextInterface } from './MenuGroup.types';
...
export interface MenuLabelPassThrough {
     ...
     */
    root?: MenuLabelPassThroughType<React.HTMLAttributes<HTMLDivElement>>;
}
/**
...
export interface MenuLabelExposes {
    ...
    /**
     * Parent MenuGroup context, when this label is rendered inside a Menu.Group.
     */
    group: MenuGroupContextInterface | undefined | null;
}
/**

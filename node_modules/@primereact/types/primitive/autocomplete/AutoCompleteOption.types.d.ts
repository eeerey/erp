...
import type { UseListboxInstance, UseListboxOptionInstance } from '@primereact/types/headless/listbox';
...
export interface AutoCompleteOptionExposes {
     ...
     */
    listbox: UseListboxInstance | undefined;
    /**
     * The useListboxOption hook instance.
     */
    listboxOption: UseListboxOptionInstance;
    /**

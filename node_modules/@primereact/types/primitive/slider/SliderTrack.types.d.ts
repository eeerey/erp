...
/**
 * Extra props applied to the track DOM element.
 */
export interface SliderTrackExtraProps {
    /**
     * Present when the slider is invalid.
     */
...
export interface SliderTrackExposes {
     ...
     * Extra props applied to the track DOM element.
     */
    extraTrackProps: SliderTrackExtraProps;
}
/**

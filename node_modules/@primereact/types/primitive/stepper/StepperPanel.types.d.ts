...
import type { StepperItemInstance } from './StepperItem.types';
...
/**
 * Pre-built props for the stepper panel element (excluding className).
 */
export interface StepperPanelElementProps {
    /**
    ...
    role: 'tabpanel';
    /**
     * ARIA controls the step with this ID.
     */
...
export interface StepperPanelExposes {
    ...
    /**
     * Pre-built props for the panel element (excluding className).
     */
    panelProps: StepperPanelElementProps;
}
/**

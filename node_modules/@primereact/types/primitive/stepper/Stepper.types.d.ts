...
export declare const StepperClassNames: {
     ...
     */
    readonly root: "p-stepper";
    /**
     * Class name of the separator element
     */
    readonly separator: "p-stepper-separator";
    /**
     * Class name of the panels element
     */
    readonly panels: "p-steppanels";
    /**
     * Class name of the panel element
     */
    readonly panel: "p-steppanel";
    /**
     * Class name of the content element
     */
    readonly content: "p-steppanel-content";
    /**
     * Class name of the list element
     */
    readonly list: "p-steplist";
    /**
     * Class name of the item element
     */
    readonly item: "p-stepitem";
    /**
     * Class name of the header element
     */
    readonly header: "p-step-header";
    /**
     * Class name of the number element
     */
    readonly number: "p-step-number";
    /**
     * Class name of the title element
     */
    readonly title: "p-step-title";
};
/**

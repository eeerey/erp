...
/**
 * Pre-built props for the stepper step element (excluding className).
 */
export interface StepperStepElementProps {
    /**
    ...
    role: 'presentation';
    /**
     * Present when the step is active.
     */
    'data-active'?: '';
    /**
     * Present when the step is disabled.
     */
    'data-disabled'?: '';
}
/**

 ...
 */
export interface TabsListProps extends BaseComponentProps<TabsListInstance, unknown, TabsListPassThrough> {
}
/**
 ...
 */
export type TabsListInstance = ComponentInstance<TabsListProps, TabsListState, TabsListExposes>;

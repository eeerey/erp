...
import type { AvatarRootInstance } from './AvatarRoot.types';
/**
 ...
 */
export interface AvatarFallbackProps extends BaseComponentProps<AvatarFallbackInstance, unknown, AvatarFallbackPassThrough> {
}
/**
...
export interface AvatarFallbackExposes {
     ...
     */
    avatar: AvatarRootInstance | undefined | null;
}
/**

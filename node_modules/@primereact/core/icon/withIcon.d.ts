import type { IconExposes, withComponentOptions } from '@primereact/types/core';
 ...
 */
export declare function withIcon<IProps, DProps, Exposes extends Record<PropertyKey, unknown> = Record<PropertyKey, unknown>, Styles = StylesOptions, CData = Record<string, unknown>>({ name, defaultProps, styles, components, setup, render }: withComponentOptions<IProps, DProps, Exposes & IconExposes, Styles, CData>): (<I extends import("@primereact/types/core").ComponentInstance, T extends React.ElementType>(inProps?: (IProps & import("@primereact/types/core").GlobalComponentProps<I, unknown, T, unknown, unknown> & {} & {} & Omit<import("@primereact/types").ExtractProps<T>, keyof import("@primereact/types/core").GlobalComponentProps<I_1, P, T_1, unknown, unknown> | keyof IProps> & DProps) | undefined) => React.JSX.Element | null) & CData & {
    displayName?: string;
};

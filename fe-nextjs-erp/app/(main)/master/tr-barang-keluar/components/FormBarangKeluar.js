...
>>>>>>> b7c2e3e6155a854ad5fd7096fbf88f53a732e07f
        NO_PENGIRIMAN: null,
        BARANG_KODE: null,
        KODE_GUDANG: null,
        KODE_RAK: null,
  ...
  return (
    ...
    >
      <div className="p-fluid grid mt-1">
        ...
        <div className="field col-6">
          <label className="font-bold text-sm">QTY Keluar <span className="text-red-500">*</span></label>
          <InputNumber
            value={formData.QTY}
        ...
        <div className="field col-6">
          <label className="font-bold text-sm">Gudang Asal <span className="text-red-500">*</span></label>
          <Dropdown

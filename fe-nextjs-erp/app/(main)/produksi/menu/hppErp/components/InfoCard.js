...
function InfoCard({ totalHPP = 0, totalCone, setTotalCone, onSave }) {
    // ======================
    // INPUT
    // ======================
    ...
    return (
      ...
      `
            ...
            <div className="info-card-head">
                ...
                <div>
                    <h2 className="info-card-title">Informasi Tambahan</h2>

                    <p className="info-card-sub">Parameter produksi & kalkulasi otomatis</p>
                </div>
            </div>
            ...
            <div className="info-results">
                {results.map((r) => (
                    <div className="info-result-row" key={r.label}>
                        ...
                        <span className="info-result-value">Rp {formatRupiah(r.value)}</span>
                    </div>
                ))}
            </div>

            <button onClick={onSave} className="info-save-btn">
                <Save size={18} />
                Simpan HPP
            </button>
        </div>
